...
import org.openlake.workSync.app.domain.exception.*;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, String>> handleProjectMembershipException(ProjectMembershipException ex) {
